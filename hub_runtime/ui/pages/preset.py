...
from webui.preset import get_presets_list, update_model_stem, add_to_flow_func, save_flow_func, reset_flow_func, reset_last_func, delete_func, load_preset, restore_preset_func, preset_backup_list


def preset(webui_config, force_cpu_flag=False, *, tasks):
	preset_inference = partial(tasks.run_ui, 'preset.preset_inference')
	preset_inference_audio = partial(tasks.run_ui, 'preset.preset_inference_audio')
	stop_preset = partial(tasks.stop_ui, 'preset')
