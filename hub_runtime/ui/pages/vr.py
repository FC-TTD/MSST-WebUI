...
from webui.vr import load_vr_model_stem


def vr(webui_config, force_cpu_flag=False, *, tasks):
	vr_inference_single = partial(tasks.run_ui, 'vr.vr_inference_single')
	vr_inference_multi = partial(tasks.run_ui, 'vr.vr_inference_multi')
	stop_vr_inference = partial(tasks.stop_ui, 'vr')
