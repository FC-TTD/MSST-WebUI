...
from webui.train import save_training_config, update_train_start_check_point, load_augmentations_config


def train(webui_config, device, *, tasks):
	start_training = tasks.start_training
	validate_model = partial(tasks.run_ui, 'train.validate_model')
	stop_msst_valid = partial(tasks.stop_ui, 'valid')
